...
class SegmentEditorWGPUGrowCut(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "SegmentEditorWGPUGrowCut"
...
class SegmentEditorWGPUGrowCutTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_WGPUGrowCut1()

  def test_WGPUGrowCut1(self):
    """
    ...
    The test can be executed from SelfTests module (test name: SegmentEditorWGPUGrowCut)
    """

    self.delayDisplay("Starting test_WGPUGrowCut1")
    ...
    segmentEditorWidget.setActiveEffectByName("WGPUGrowCut")
    ...
    self.delayDisplay('test_WGPUGrowCut1 passed')
